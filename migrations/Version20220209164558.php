 ...
 */
final class Version20220209164558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_activite (user_id INTEGER NOT NULL, activite_id INTEGER NOT NULL, PRIMARY KEY(user_id, activite_id))');
        $this->addSql('CREATE INDEX IDX_58F8B115A76ED395 ON user_activite (user_id)');
        $this->addSql('CREATE INDEX IDX_58F8B1159B0F88B1 ON user_activite (activite_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enfant (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) DEFAULT NULL COLLATE BINARY, prenom VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
